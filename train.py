...
class MVSSystem(LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        log['train/loss'] = loss = self.loss(results, depths, masks, semantics, planar_masks)      # newly added
    ...
    def validation_step(self, batch, batch_nb):
        ...
        log['val_loss'] = self.loss(results, depths, masks, semantics, planar_masks)              # newly added
