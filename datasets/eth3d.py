...
#         mask = cv2.imread(filename, 0) # (1200, 1600)   # returns a <class 'numpy.ndarray'>  uint8, 1-channel shape (because flags=0) with unique values [0 255]
